...
: ${AMENT_CURRENT_PREFIX:="/home/ale/Proyecto_CPR/rosbot_ws/install/open_manipulator_x_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/open_manipulator_x_description/environment/setup_envs.sh"
